	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12 mt-120">
				<h1 class="mb-40 is-block-reveal"><?php the_archive_title(); ?></h1>
			</div><!-- end col-sm-12 -->
		</div><!-- end row -->
	</div>	<!-- end container -->
	...
	<div class="BlogVertical container mb-80">
		...
		<?php if ( have_posts() ) : while (have_posts()) : the_post(); ?>
				...
				<article <?php post_class(esc_attr($post_classes)); ?> id="post-<?php the_ID(); ?>">
					...
					<?php endif; ?>
						<div class="SpecialHeading">
							<a href="<?php echo esc_url(get_permalink()); ?>"><h2 class="special-title is-block-reveal"><?php the_title(); ?></h2></a>
