...
class FW_Option_Type_Icon_Select extends FW_Option_Type
{
    ...
    protected function _enqueue_static($id, $option, $data)
    {
        ...
        wp_enqueue_style(
            ...
            get_template_directory_uri() .'/inc/includes/option-types/'. $this->get_type() .'/icons/unyson-iconselect-icons.css'
        );
    ...
    protected function _render($id, $option, $data)
    {
        ...
        if ( $wp_filesystem->exists($json_file) ) {
            ...
            if(!$json_content) {
                return new WP_Error('reading_error', esc_html__('Error when reading file', 'vivian')); 
            }
            ...
            echo esc_html__('Error: JSON file not found', 'vivian'); 
            return false;
        }
        ...
        $html .= '<option value="">'. esc_html__('None', 'vivian').'</option>';
