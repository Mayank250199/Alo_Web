<?php
/* Template Name: Portfolio - Gallery Media */
get_header();
?>
...
<div id="post-<?php the_ID(); ?>">
	...
	get_template_part( 'partials/content', 'portfolio-gallery-media-filter' ); 
	} 
	?>
	<?php get_template_part( 'loop/loop', 'portfolio-gallery-media' ); ?>
